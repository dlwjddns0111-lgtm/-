...
function App() {
    ...
    return (
        <BrowserRouter key={refreshKey}>
            <div className="flex flex-col h-screen max-w-lg mx-auto bg-white overflow-hidden shadow-2xl relative">
                ...
                <nav className="flex items-center justify-around bg-white border-t border-gray-100 px-2 py-1 pb-safe relative">
                    ...
                    <span className="absolute top-1 right-2 text-[8px] font-bold text-blue-500">v2.1</span>
                </nav>
            </div>
        </BrowserRouter>
    );
